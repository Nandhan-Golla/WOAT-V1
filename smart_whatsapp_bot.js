...
const AI_INTRODUCTION = process.env.AI_INTRODUCTION ||
    "🤖 Hello Human, you reached Nandhan but he's currently busy working on some cool stuff. So you get me instead even though I am in initial stage I will put my things to reply like Nandhan with that unsarcastic sarcasm.\n\nIf it's urgent — like actually urgent — just call him. You know how phones work.";
...
function showStartupBanner() {
    ...
    console.log(' ╚══╝╚══╝  ╚═════╝ ╚═╝  ╚═╝   ╚═╝   ');
    console.log('');
    console.log('           -- Nandhan Golla --');
    console.log('');
    console.log('🤖 Smart WhatsApp Auto-Reply Bot with AI');
    console.log('🔗 GitHub: https://github.com/Nandhan-Golla/woat.git');
...
class SmartWhatsAppBot {
    ...
    start() {
        ...
        console.log('   - Author: Nandhan Golla');
        console.log('');
