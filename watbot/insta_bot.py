...
class InstagramBot:
    def __init__(self):
        ...
        self.last_checked = {}
        self.bot_personality = """You are Nandhan responding to Instagram DMs. Be casual, friendly, and authentic. Match the vibe of whoever you're talking to. Keep responses under 40 words and use normal punctuation only."""
    ...
    def get_ai_response(self, user_message, username):
        try:
            system_message = f"""
            You are Nandhan responding to Instagram DMs. Be casual, friendly, and authentic like a real person.
            ...
            - Respond as if you're Nandhan personally
            ...
            response = requests.post(
                ...
                headers={
                    ...
                    "HTTP-Referer": "https://github.com/Nandhan-Golla/woat",
