...
setup(
    name="watbot",
    version="0.1.1",
    author="Nandhan Golla",
    author_email="nandhan@example.com",
    description="WhatsApp & Instagram Automation Bot with AI-powered responses",
    long_description=read_file("README.md"),
    long_description_content_type="text/markdown",
    
    # Project URLs
    url="https://github.com/Nandhan-Golla/woat",
    project_urls={
        "Bug Tracker": "https://github.com/Nandhan-Golla/woat/issues",
        "Documentation": "https://github.com/Nandhan-Golla/woat/wiki",
        "Source Code": "https://github.com/Nandhan-Golla/woat",
    },
